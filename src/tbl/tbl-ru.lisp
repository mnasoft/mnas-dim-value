...
(block table-6
  ...
  (nd "напряженность электрического поля" nil "вольт на метр" "В/м" (vd 1 :kg 1 :m 1 :s -3 :A -1))    ; "V m−1=kg m s−3 A−1"
  ...
  (nd "энергетическая яркость" nil "ватт на стерадиан-квадратный метр" "Вт/(ср*м^2)" (vd 1 :kg 1 :s -3 :sr -1))        ; "W sr−1 m−2=kg s−3"
